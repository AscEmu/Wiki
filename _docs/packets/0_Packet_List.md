...
[CMSG_WORLD_TELEPORT](#cmsg_world_teleport) |  |  | serialized |  | 
...
[CMSG_CHAR_CREATE](#cmsg_char_create) |  |  | serialized |  | serialized
[CMSG_CHAR_ENUM](#cmsg_char_enum) |  |  |  |  | 
[CMSG_CHAR_DELETE](#cmsg_char_delete) |  |  | serialized |  | serialized
[SMSG_AUTH_SRP6_RESPONSE](#smsg_auth_srp6_response) |  |  |  |  | 
[SMSG_CHAR_CREATE](#smsg_char_create) |  |  | serialized |  | 
[SMSG_CHAR_ENUM](#smsg_char_enum) |  |  | serialized |  | 
[SMSG_CHAR_DELETE](#smsg_char_delete) |  |  | serialized |  | 
[CMSG_PLAYER_LOGIN](#cmsg_player_login) |  |  | serialized |  | 
[SMSG_NEW_WORLD](#smsg_new_world) |  |  | serialized |  | 
[SMSG_TRANSFER_PENDING](#smsg_transfer_pending) |  |  |  |  | 
[SMSG_TRANSFER_ABORTED](#smsg_transfer_aborted) |  |  |  |  | 
[SMSG_CHARACTER_LOGIN_FAILED](#smsg_character_login_failed) |  |  | serialized |  | 
...
[SMSG_LOGOUT_RESPONSE](#smsg_logout_response) |  |  | serialized |  | 
...
[CMSG_GUILD_QUERY](#cmsg_guild_query) |  |  | serialized | serialized | 
[SMSG_GUILD_QUERY_RESPONSE](#smsg_guild_query_response) |  |  |  |  | 
[CMSG_ITEM_QUERY_SINGLE](#cmsg_item_query_single) |  |  | serialized |  | 
...
[CMSG_QUEST_QUERY](#cmsg_quest_query) |  |  | serialized |  | 
...
[SMSG_WHO](#smsg_who) |  |  |  |  | 
[CMSG_WHOIS](#cmsg_whois) |  |  | serialized |  | 
...
[SMSG_FRIEND_STATUS](#smsg_friend_status) |  |  | serialized |  | 
...
[SMSG_GROUP_DECLINE](#smsg_group_decline) |  |  | serialized |  | 
[CMSG_GROUP_UNINVITE](#cmsg_group_uninvite) |  |  | serialized |  | 
[CMSG_GROUP_UNINVITE_GUID](#cmsg_group_uninvite_guid) |  |  | serialized |  | 
[SMSG_GROUP_UNINVITE](#smsg_group_uninvite) |  |  |  |  | 
[CMSG_GROUP_SET_LEADER](#cmsg_group_set_leader) |  |  | serialized |  | 
[SMSG_GROUP_SET_LEADER](#smsg_group_set_leader) |  |  |  |  | 
[CMSG_LOOT_METHOD](#cmsg_loot_method) |  |  | serialized |  | 
...
[SMSG_PARTY_COMMAND_RESULT](#smsg_party_command_result) |  |  | serialized |  | 
[UMSG_UPDATE_GROUP_MEMBERS](#umsg_update_group_members) |  |  |  |  | 
[CMSG_GUILD_CREATE](#cmsg_guild_create) |  |  |  |  | 
[CMSG_GUILD_INVITE](#cmsg_guild_invite) |  |  | serialized | serialized | 
[SMSG_GUILD_INVITE](#smsg_guild_invite) |  |  | serialized |  | 
...
[SMSG_GUILD_INFO](#smsg_guild_info) |  |  | serialized |  | 
[CMSG_GUILD_ROSTER](#cmsg_guild_roster) |  |  |  |  | 
[SMSG_GUILD_ROSTER](#smsg_guild_roster) |  |  |  |  | 
[CMSG_GUILD_PROMOTE](#cmsg_guild_promote) |  |  | serialized | serialized | 
[CMSG_GUILD_DEMOTE](#cmsg_guild_demote) |  |  | serialized | serialized | 
[CMSG_GUILD_LEAVE](#cmsg_guild_leave) |  |  |  |  | 
[CMSG_GUILD_REMOVE](#cmsg_guild_remove) |  |  | serialized | serialized | 
[CMSG_GUILD_DISBAND](#cmsg_guild_disband) |  |  |  |  | 
[CMSG_GUILD_LEADER](#cmsg_guild_leader) |  |  | serialized | serialized | 
[CMSG_GUILD_MOTD](#cmsg_guild_motd) |  |  | serialized | serialized | 
[SMSG_GUILD_EVENT](#smsg_guild_event) |  |  | serialized |  | 
[SMSG_GUILD_COMMAND_RESULT](#smsg_guild_command_result) |  |  | serialized |  | 
[UMSG_UPDATE_GUILD](#umsg_update_guild) |  |  |  |  | 
[CMSG_MESSAGECHAT](#cmsg_messagechat) |  | serialized | serialized | 
[SMSG_MESSAGECHAT](#smsg_messagechat) |  |  | serialized |  | 
[CMSG_JOIN_CHANNEL](#cmsg_join_channel) |  | serialized | serialized | 
[CMSG_LEAVE_CHANNEL](#cmsg_leave_channel) |  |  | serialized |  | 
[SMSG_CHANNEL_NOTIFY](#smsg_channel_notify) |  |  |  |  | 
[CMSG_CHANNEL_LIST](#cmsg_channel_list) |  |  | serialized |  | 
[SMSG_CHANNEL_LIST](#smsg_channel_list) |  |  |  |  | 
[CMSG_CHANNEL_PASSWORD](#cmsg_channel_password) |  |  | serialized |  | 
[CMSG_CHANNEL_SET_OWNER](#cmsg_channel_set_owner) |  |  | serialized |  | 
[CMSG_CHANNEL_OWNER](#cmsg_channel_owner) |  |  | serialized |  | 
[CMSG_CHANNEL_MODERATOR](#cmsg_channel_moderator) |  |  | serialized |  | 
[CMSG_CHANNEL_UNMODERATOR](#cmsg_channel_unmoderator) |  |  | serialized |  | 
[CMSG_CHANNEL_MUTE](#cmsg_channel_mute) |  |  | serialized |  | 
[CMSG_CHANNEL_UNMUTE](#cmsg_channel_unmute) |  |  | serialized |  | 
[CMSG_CHANNEL_INVITE](#cmsg_channel_invite) |  |  | serialized |  | 
[CMSG_CHANNEL_KICK](#cmsg_channel_kick) |  |  | serialized |  | 
[CMSG_CHANNEL_BAN](#cmsg_channel_ban) |  |  | serialized |  | 
[CMSG_CHANNEL_UNBAN](#cmsg_channel_unban) |  |  | serialized |  | 
[CMSG_CHANNEL_ANNOUNCEMENTS](#cmsg_channel_announcements) |  |  | serialized |  | 
[CMSG_CHANNEL_MODERATE](#cmsg_channel_moderate) |  |  | serialized |  | 
[SMSG_UPDATE_OBJECT](#smsg_update_object) |  |  | serialized |  | 
[SMSG_DESTROY_OBJECT](#smsg_destroy_object) |  | serialized | serialized | 
[CMSG_USE_ITEM](#cmsg_use_item) |  |  | serialized |  | 
[CMSG_OPEN_ITEM](#cmsg_open_item) |  |  | serialized | 
[CMSG_READ_ITEM](#cmsg_read_item) |  |  | serialized |  | 
[SMSG_READ_ITEM_OK](#smsg_read_item_ok) |  |  | serialized |  | 
[SMSG_READ_ITEM_FAILED](#smsg_read_item_failed) |  |  | serialized |  | 
[SMSG_ITEM_COOLDOWN](#smsg_item_cooldown) |  |  |  |  | 
[CMSG_GAMEOBJ_USE](#cmsg_gameobj_use) |  |  | serialized |  | 
[CMSG_DESTROY_ITEMS](#cmsg_destroy_items) |  |  | serialized |  | 
...
[MSG_MOVE_TELEPORT_ACK](#msg_move_teleport_ack) |  |  | serialized | serialized | 
[MSG_MOVE_TOGGLE_FALL_LOGGING](#msg_move_toggle_fall_logging) |  |  |  |  | 
[MSG_MOVE_FALL_LAND](#msg_move_fall_land) | serialized | serialized | serialized |  | 
...
[SMSG_MOVE_KNOCK_BACK](#smsg_move_knock_back) |  |  | serialized |  | 
...
[CMSG_INITIATE_TRADE](#cmsg_initiate_trade) |  |  | serialized |  | 
...
[CMSG_SET_TRADE_ITEM](#cmsg_set_trade_item) |  |  | serialized |  | 
[CMSG_CLEAR_TRADE_ITEM](#cmsg_clear_trade_item) |  |  | serialized |  | 
[CMSG_SET_TRADE_GOLD](#cmsg_set_trade_gold) |  |  | serialized |  | 
[SMSG_TRADE_STATUS](#smsg_trade_status) |  |  | serialized |  | 
...
[SMSG_COOLDOWN_EVENT](#smsg_cooldown_event) |  |  | serialized |  | 
...
[CMSG_ATTACKSWING](#cmsg_attackswing) |  |  | serialized |  | 
[CMSG_ATTACKSTOP](#cmsg_attackstop) |  |  |  |  | 
[SMSG_ATTACKSTART](#smsg_attackstart) |  |  | serialized |  | 
[SMSG_ATTACKSTOP](#smsg_attackstop) |  |  | serialized |  | 
...
[SMSG_BINDPOINTUPDATE](#smsg_bindpointupdate) |  |  | serialized |  | 
[CMSG_GETDEATHBINDZONE](#cmsg_getdeathbindzone) |  |  |  |  | 
[SMSG_BINDZONEREPLY](#smsg_bindzonereply) |  |  |  |  | 
[SMSG_PLAYERBOUND](#smsg_playerbound) |  |  |  |  | 
[SMSG_CLIENT_CONTROL_UPDATE](#smsg_client_control_update) |  |  | serialized |  | 
...
[SMSG_LOOT_RELEASE_RESPONSE](#smsg_loot_release_response) |  |  | serialized |  | 
[SMSG_LOOT_REMOVED](#smsg_loot_removed) |  | serialized | serialized | 
[SMSG_LOOT_MONEY_NOTIFY](#smsg_loot_money_notify) |  |  | serialized |  | 
[SMSG_LOOT_ITEM_NOTIFY](#smsg_loot_item_notify) |  |  |  |  | 
[SMSG_LOOT_CLEAR_MONEY](#smsg_loot_clear_money) |  |  |  |  | 
[SMSG_ITEM_PUSH_RESULT](#smsg_item_push_result) |  |  | serialized |  | 
[SMSG_DUEL_REQUESTED](#smsg_duel_requested) |  |  |  |  | 
[SMSG_DUEL_OUTOFBOUNDS](#smsg_duel_outofbounds) |  |  |  |  | 
[SMSG_DUEL_INBOUNDS](#smsg_duel_inbounds) |  |  |  |  | 
[SMSG_DUEL_COMPLETE](#smsg_duel_complete) |  |  | serialized |  | 
[SMSG_DUEL_WINNER](#smsg_duel_winner) |  |  | serialized |  | 
[CMSG_DUEL_ACCEPTED](#cmsg_duel_accepted) |  |  |  |  | 
[CMSG_DUEL_CANCELLED](#cmsg_duel_cancelled) |  |  |  |  | 
[SMSG_MOUNTRESULT](#smsg_mountresult) |  |  | serialized |  | 
[SMSG_DISMOUNTRESULT](#smsg_dismountresult) |  |  | serialized |  | 
...
[CMSG_GOSSIP_HELLO](#cmsg_gossip_hello) |  |  | serialized |  | 
...
[SMSG_QUESTGIVER_STATUS](#smsg_questgiver_status) |  |  | serialized |  | 
[CMSG_QUESTGIVER_HELLO](#cmsg_questgiver_hello) |  |  | serialized |  | 
[SMSG_QUESTGIVER_QUEST_LIST](#smsg_questgiver_quest_list) |  |  |  |  | 
[CMSG_QUESTGIVER_QUERY_QUEST](#cmsg_questgiver_query_quest) |  |  | serialized | serialized | 
...
[CMSG_QUESTGIVER_ACCEPT_QUEST](#cmsg_questgiver_accept_quest) |  |  | serialized |  | 
[CMSG_QUESTGIVER_COMPLETE_QUEST](#cmsg_questgiver_complete_quest) |  |  | serialized |  | 
[SMSG_QUESTGIVER_REQUEST_ITEMS](#smsg_questgiver_request_items) |  |  |  |  | 
[CMSG_QUESTGIVER_REQUEST_REWARD](#cmsg_questgiver_request_reward) |  |  | serialized |  | 
[SMSG_QUESTGIVER_OFFER_REWARD](#smsg_questgiver_offer_reward) |  |  |  |  | 
[CMSG_QUESTGIVER_CHOOSE_REWARD](#cmsg_questgiver_choose_reward) |  |  | serialized |  | 
...
[CMSG_QUESTLOG_REMOVE_QUEST](#cmsg_questlog_remove_quest) |  |  | serialized |  | 
...
[CMSG_PUSHQUESTTOPARTY](#cmsg_pushquesttoparty) |  |  | serialized |  | 
[CMSG_LIST_INVENTORY](#cmsg_list_inventory) |  |  | serialized |  | 
[SMSG_LIST_INVENTORY](#smsg_list_inventory) |  |  |  |  | 
[CMSG_SELL_ITEM](#cmsg_sell_item) |  |  | serialized |  | 
[SMSG_SELL_ITEM](#smsg_sell_item) |  |  | serialized |  | 
[CMSG_BUY_ITEM](#cmsg_buy_item) |  |  | serialized |  | 
[CMSG_BUY_ITEM_IN_SLOT](#cmsg_buy_item_in_slot) |  |  | serialized |  | 
[SMSG_BUY_ITEM](#smsg_buy_item) |  | serialized | serialized | serialized | 
[SMSG_BUY_FAILED](#smsg_buy_failed) |  |  | serialized |  | 
...
[SMSG_SHOWTAXINODES](#smsg_showtaxinodes) |  |  | serialized |  | 
[CMSG_TAXINODE_STATUS_QUERY](#cmsg_taxinode_status_query) |  |  | serialized |  | 
[SMSG_TAXINODE_STATUS](#smsg_taxinode_status) |  |  | serialized |  | 
[CMSG_TAXIQUERYAVAILABLENODES](#cmsg_taxiqueryavailablenodes) |  |  | serialized |  | 
[CMSG_ACTIVATETAXI](#cmsg_activatetaxi) |  |  | serialized |  | 
[SMSG_ACTIVATETAXIREPLY](#smsg_activatetaxireply) |  |  | serialized |  | 
[SMSG_NEW_TAXI_PATH](#smsg_new_taxi_path) |  |  |  |  | 
[CMSG_TRAINER_LIST](#cmsg_trainer_list) |  |  | serialized |  | 
[SMSG_TRAINER_LIST](#smsg_trainer_list) |  |  |  |  | 
[CMSG_TRAINER_BUY_SPELL](#cmsg_trainer_buy_spell) |  |  | serialized |  | 
[SMSG_TRAINER_BUY_SUCCEEDED](#smsg_trainer_buy_succeeded) |  |  | serialized |  | 
[SMSG_TRAINER_BUY_FAILED](#smsg_trainer_buy_failed) |  |  |  |  | 
[CMSG_BINDER_ACTIVATE](#cmsg_binder_activate) |  |  | serialized |  | 
[SMSG_PLAYERBINDERROR](#smsg_playerbinderror) |  |  |  |  | 
[CMSG_BANKER_ACTIVATE](#cmsg_banker_activate) |  |  | serialized |  | 
[SMSG_SHOW_BANK](#smsg_show_bank) |  |  | serialized |  | 
[CMSG_BUY_BANK_SLOT](#cmsg_buy_bank_slot) |  |  | serialized |  | 
[SMSG_BUY_BANK_SLOT_RESULT](#smsg_buy_bank_slot_result) |  |  | serialized |  | 
[CMSG_PETITION_SHOWLIST](#cmsg_petition_showlist) |  |  | serialized |  | 
[SMSG_PETITION_SHOWLIST](#smsg_petition_showlist) |  |  | serialized |  | 
[CMSG_PETITION_BUY](#cmsg_petition_buy) |  |  |  | serialized | 
[CMSG_PETITION_SHOW_SIGNATURES](#cmsg_petition_show_signatures) |  |  | serialized |  | 
[SMSG_PETITION_SHOW_SIGNATURES](#smsg_petition_show_signatures) |  |  | serialized |  | 
[CMSG_PETITION_SIGN](#cmsg_petition_sign) |  |  | serialized |  | 
[SMSG_PETITION_SIGN_RESULTS](#smsg_petition_sign_results) |  |  | serialized |  | 
[MSG_PETITION_DECLINE](#msg_petition_decline) |  |  | serialized |  | 
[CMSG_OFFER_PETITION](#cmsg_offer_petition) |  |  | serialized |  | 
[CMSG_TURN_IN_PETITION](#cmsg_turn_in_petition) |  |  | serialized |  | 
[SMSG_TURN_IN_PETITION_RESULTS](#smsg_turn_in_petition_results) |  |  |  |  | 
[CMSG_PETITION_QUERY](#cmsg_petition_query) |  |  | serialized |  | 
[SMSG_PETITION_QUERY_RESPONSE](#smsg_petition_query_response) |  |  | serialized |  | 
[SMSG_FISH_NOT_HOOKED](#smsg_fish_not_hooked) |  |  |  |  | 
[SMSG_FISH_ESCAPED](#smsg_fish_escaped) |  |  |  |  | 
[CMSG_BUG](#cmsg_bug) |  |  | serialized |  | 
...
[CMSG_QUERY_TIME](#cmsg_query_time) |  |  | serialized |  | 
[SMSG_QUERY_TIME_RESPONSE](#smsg_query_time_response) |  |  | serialized |  | 
[SMSG_LOG_XPGAIN](#smsg_log_xpgain) |  |  | serialized |  | 
[SMSG_AURACASTLOG_OBSOLETE](#smsg_auracastlog_obsolete) |  |  |  |  | 
[CMSG_RECLAIM_CORPSE](#cmsg_reclaim_corpse) |  |  | serialized |  | 
[CMSG_WRAP_ITEM](#cmsg_wrap_item) |  |  | serialized |  | 
[SMSG_LEVELUP_INFO](#smsg_levelup_info) |  |  | serialized |  | 
[MSG_MINIMAP_PING](#msg_minimap_ping) |  |  | serialized |  | 
...
[SMSG_STOP_MIRROR_TIMER](#smsg_stop_mirror_timer) |  |  | serialized |  | 
[CMSG_PING](#cmsg_ping) |  |  |  |  | 
[SMSG_PONG](#smsg_pong) |  |  |  |  | 
...
[CMSG_PET_CAST_SPELL](#cmsg_pet_cast_spell) |  |  | serialized |  | 
[MSG_SAVE_GUILD_EMBLEM](#msg_save_guild_emblem) |  |  | serialized |  | 
[MSG_TABARDVENDOR_ACTIVATE](#msg_tabardvendor_activate) |  |  | serialized |  | 
[SMSG_PLAY_SPELL_VISUAL](#smsg_play_spell_visual) |  |  |  |  | 
[CMSG_ZONEUPDATE](#cmsg_zoneupdate) |  |  | serialized |  | 
[SMSG_PARTYKILLLOG](#smsg_partykilllog) |  |  | serialized |  | 
[SMSG_COMPRESSED_UPDATE_OBJECT](#smsg_compressed_update_object) |  |  |  |  | 
[SMSG_PLAY_SPELL_IMPACT](#smsg_play_spell_impact) |  |  |  |  | 
[SMSG_EXPLORATION_EXPERIENCE](#smsg_exploration_experience) |  |  | serialized |  | 
[CMSG_GM_SET_SECURITY_GROUP](#cmsg_gm_set_security_group) |  |  |  |  | 
[CMSG_GM_NUKE](#cmsg_gm_nuke) |  |  |  |  | 
[MSG_RANDOM_ROLL](#msg_random_roll) |  |  | serialized | 
[SMSG_ENVIRONMENTALDAMAGELOG](#smsg_environmentaldamagelog) |  |  | serialized |  | 
[CMSG_RWHOIS_OBSOLETE](#cmsg_rwhois_obsolete) |  |  |  |  | 
[SMSG_RWHOIS](#smsg_rwhois) |  |  |  |  | 
[SMSG_LFG_PLAYER_REWARD](#smsg_lfg_player_reward) |  |  |  |  | 
[SMSG_LFG_TELEPORT_DENIED](#smsg_lfg_teleport_denied) |  |  | serialized |  | 
[CMSG_UNLEARN_SPELL](#cmsg_unlearn_spell) |  |  |  |  | 
[CMSG_UNLEARN_SKILL](#cmsg_unlearn_skill) |  |  | serialized |  | 
[SMSG_REMOVED_SPELL](#smsg_removed_spell) |  |  |  |  | 
[CMSG_DECHARGE](#cmsg_decharge) |  |  |  |  | 
[CMSG_GMTICKET_CREATE](#cmsg_gmticket_create) |  |  | serialized |  | 
[SMSG_GMTICKET_CREATE](#smsg_gmticket_create) |  |  | serialized |  | 
[CMSG_GMTICKET_UPDATETEXT](#cmsg_gmticket_updatetext) |  |  | serialized |  | 
[SMSG_GMTICKET_UPDATETEXT](#smsg_gmticket_updatetext) |  |  | serialized |  | 
[SMSG_ACCOUNT_DATA_TIMES](#smsg_account_data_times) |  |  |  |  | 
[CMSG_REQUEST_ACCOUNT_DATA](#cmsg_request_account_data) |  |  |  |  | 
[CMSG_UPDATE_ACCOUNT_DATA](#cmsg_update_account_data) |  |  | serialized | serialized | 
...
[SMSG_GMTICKET_GETTICKET](#smsg_gmticket_getticket) |  |  | serialized |  | 
...
[SMSG_GMTICKET_DELETETICKET](#smsg_gmticket_deleteticket) |  |  | serialized |  | 
[SMSG_CHAT_WRONG_FACTION](#smsg_chat_wrong_faction) |  |  |  |  | 
[CMSG_GMTICKET_SYSTEMSTATUS](#cmsg_gmticket_systemstatus) |  |  |  |  | 
[SMSG_GMTICKET_SYSTEMSTATUS](#smsg_gmticket_systemstatus) |  |  | serialized |  | 
...
[SMSG_SPIRIT_HEALER_CONFIRM](#smsg_spirit_healer_confirm) |  |  | serialized |  | 
[CMSG_CHARACTER_POINT_CHEAT](#cmsg_character_point_cheat) |  |  |  |  | 
[SMSG_GOSSIP_POI](#smsg_gossip_poi) |  |  | serialized |  | 
[CMSG_CHAT_IGNORED](#cmsg_chat_ignored) |  |  | serialized |  | 
...
[CMSG_GUILD_ADD_RANK](#cmsg_guild_add_rank) |  |  | serialized |  | 
[CMSG_GUILD_DEL_RANK](#cmsg_guild_del_rank) |  |  | serialized |  | 
[CMSG_GUILD_SET_PUBLIC_NOTE](#cmsg_guild_set_public_note) |  |  |  | serialized | 
[CMSG_GUILD_SET_OFFICER_NOTE](#cmsg_guild_set_officer_note) |  |  | serialized |  | 
[SMSG_LOGIN_VERIFY_WORLD](#smsg_login_verify_world) |  |  | serialized |  | 
[CMSG_CLEAR_EXPLORATION](#cmsg_clear_exploration) |  |  |  |  | 
[CMSG_SEND_MAIL](#cmsg_send_mail) |  |  | serialized |  | 
[SMSG_SEND_MAIL_RESULT](#smsg_send_mail_result) |  |  | serialized |  | 
...
[CMSG_LEARN_TALENT](#cmsg_learn_talent) |  |  | serialized |  | 
[SMSG_RESURRECT_FAILED](#smsg_resurrect_failed) |  |  | serialized |  | 
[CMSG_TOGGLE_PVP](#cmsg_toggle_pvp) | no data | no data | no data | no data
[SMSG_ZONE_UNDER_ATTACK](#smsg_zone_under_attack) |  |  |  |  | 
[MSG_AUCTION_HELLO](#msg_auction_hello) |  |  | serialized |  | 
[CMSG_AUCTION_SELL_ITEM](#cmsg_auction_sell_item) |  |  | serialized | 
[CMSG_AUCTION_REMOVE_ITEM](#cmsg_auction_remove_item) |  |  | serialized | 
[CMSG_AUCTION_LIST_ITEMS](#cmsg_auction_list_items) |  |  | serialized | 
[CMSG_AUCTION_LIST_OWNER_ITEMS](#cmsg_auction_list_owner_items) |  |  | serialized | 
[CMSG_AUCTION_PLACE_BID](#cmsg_auction_place_bid) |  |  | serialized | 
[SMSG_AUCTION_COMMAND_RESULT](#smsg_auction_command_result) |  |  | serialized | 
...
[CMSG_AUCTION_LIST_BIDDER_ITEMS](#cmsg_auction_list_bidder_items) |  |  | serialized |  | 
[SMSG_AUCTION_BIDDER_LIST_RESULT](#smsg_auction_bidder_list_result) |  |  |  |  | 
[SMSG_SET_FLAT_SPELL_MODIFIER](#smsg_set_flat_spell_modifier) |  |  | serialized |  | 
[SMSG_SET_PCT_SPELL_MODIFIER](#smsg_set_pct_spell_modifier) |  |  | serialized |  | 
[CMSG_SET_AMMO](#cmsg_set_ammo) |  |  |  |  | 
[SMSG_CORPSE_RECLAIM_DELAY](#smsg_corpse_reclaim_delay) |  |  | serialized |  | 
[CMSG_SET_ACTIVE_MOVER](#cmsg_set_active_mover) |  |  | serialized |  | 
[CMSG_PET_CANCEL_AURA](#cmsg_pet_cancel_aura) |  |  | serialized |  | 
...
[MSG_LIST_STABLED_PETS](#msg_list_stabled_pets) |  |  | serialized |  | 
[CMSG_STABLE_PET](#cmsg_stable_pet) |  |  |  |  | 
[CMSG_UNSTABLE_PET](#cmsg_unstable_pet) |  |  | serialized |  | 
[CMSG_BUY_STABLE_SLOT](#cmsg_buy_stable_slot) |  |  |  |  | 
[SMSG_STABLE_RESULT](#smsg_stable_result) |  |  | serialized |  | 
[CMSG_STABLE_REVIVE_PET](#cmsg_stable_revive_pet) |  |  |  |  | 
[CMSG_STABLE_SWAP_PET](#cmsg_stable_swap_pet) |  |  | serialized |  | 
[MSG_QUEST_PUSH_RESULT](#msg_quest_push_result) |  |  | serialized |  | 
[SMSG_PLAY_MUSIC](#smsg_play_music) |  |  |  |  | 
[SMSG_PLAY_OBJECT_SOUND](#smsg_play_object_sound) |  |  | serialized |  | 
...
[CMSG_GROUP_CHANGE_SUB_GROUP](#cmsg_group_change_sub_group) |  |  | serialized |  | 
[CMSG_REQUEST_PARTY_MEMBER_STATS](#cmsg_request_party_member_stats) |  |  | serialized |  | 
[CMSG_GROUP_SWAP_SUB_GROUP](#cmsg_group_swap_sub_group) |  |  |  |  | 
[CMSG_RESET_FACTION_CHEAT](#cmsg_reset_faction_cheat) |  |  |  |  | 
[CMSG_AUTOSTORE_BANK_ITEM](#cmsg_autostore_bank_item) |  |  | serialized |  | 
[CMSG_AUTOBANK_ITEM](#cmsg_autobank_item) |  |  | serialized |  | 
...
[CMSG_GROUP_ASSISTANT_LEADER](#cmsg_group_assistant_leader) |  |  | serialized |  | 
[CMSG_BUYBACK_ITEM](#cmsg_buyback_item) |  |  | serialized |  | 
[SMSG_SERVER_MESSAGE](#smsg_server_message) |  |  |  |  | 
[CMSG_MEETINGSTONE_JOIN](#cmsg_meetingstone_join) |  |  |  |  | 
[SMSG_LFG_OFFER_CONTINUE](#smsg_lfg_offer_continue) |  |  | serialized |  | 
[CMSG_MEETINGSTONE_CHEAT](#cmsg_meetingstone_cheat) |  |  |  |  | 
[SMSG_MEETINGSTONE_SETQUEUE](#smsg_meetingstone_setqueue) |  |  | serialized |  | 
...
[SMSG_STANDSTATE_UPDATE](#smsg_standstate_update) |  |  | serialized |  | 
...
[SMSG_LOOT_MASTER_LIST](#smsg_loot_master_list) |  |  | serialized |  | 
...
[CMSG_REPAIR_ITEM](#cmsg_repair_item) |  |  | serialized |  | 
[SMSG_CHAT_PLAYER_NOT_FOUND](#smsg_chat_player_not_found) |  |  | serialized |  | 
[MSG_TALENT_WIPE_CONFIRM](#msg_talent_wipe_confirm) |  |  | serialized |  | 
[SMSG_SUMMON_REQUEST](#smsg_summon_request) |  |  | serialized |  | 
[CMSG_SUMMON_RESPONSE](#cmsg_summon_response) |  |  | serialized |  | 
[MSG_MOVE_TOGGLE_GRAVITY_CHEAT](#msg_move_toggle_gravity_cheat) |  |  |  |  | 
[SMSG_MONSTER_MOVE_TRANSPORT](#smsg_monster_move_transport) |  |  | serialized |  | 
...
[SMSG_DUEL_COUNTDOWN](#smsg_duel_countdown) |  |  | serialized |  | 
[SMSG_AREA_TRIGGER_MESSAGE](#smsg_area_trigger_message) |  |  | serialized | 
[CMSG_TOGGLE_HELM](#cmsg_toggle_helm) |  |  |  |  | 
[CMSG_TOGGLE_CLOAK](#cmsg_toggle_cloak) |  |  |  |  | 
[SMSG_LFG_ROLE_CHOSEN](#smsg_lfg_role_chosen) |  |  | serialized |  | 
...
[MSG_PETITION_RENAME](#msg_petition_rename) |  |  |  | serialized | 
[SMSG_INIT_WORLD_STATES](#smsg_init_world_states) |  |  |  |  | 
[SMSG_UPDATE_WORLD_STATE](#smsg_update_world_state) |  |  |  |  | 
[CMSG_ITEM_NAME_QUERY](#cmsg_item_name_query) |  |  | serialized | 
[SMSG_ITEM_NAME_QUERY_RESPONSE](#smsg_item_name_query_response) |  |  | serialized |  | 
[SMSG_PET_ACTION_FEEDBACK](#smsg_pet_action_feedback) |  |  |  |  | 
[CMSG_CHAR_RENAME](#cmsg_char_rename) |  |  | serialized |  | 
[SMSG_CHAR_RENAME](#smsg_char_rename) |  |  | serialized |  | 
...
[SMSG_PLAY_SOUND](#smsg_play_sound) |  |  | serialized |  | 
...
[CMSG_AREA_SPIRIT_HEALER_QUERY](#cmsg_area_spirit_healer_query) |  |  | serialized |  | 
[CMSG_AREA_SPIRIT_HEALER_QUEUE](#cmsg_area_spirit_healer_queue) |  |  | serialized |  | 
[SMSG_AREA_SPIRIT_HEALER_TIME](#smsg_area_spirit_healer_time) |  |  | serialized |  | 
...
[SMSG_BINDER_CONFIRM](#smsg_binder_confirm) |  |  | serialized |  | 
...
[CMSG_BATTLEMASTER_JOIN](#cmsg_battlemaster_join) |  |  | serialized | 
[SMSG_ADDON_INFO](#smsg_addon_info) |  |  |  |  | 
[CMSG_PET_UNLEARN](#cmsg_pet_unlearn) |  |  | serialized |  | 
[SMSG_PET_UNLEARN_CONFIRM](#smsg_pet_unlearn_confirm) |  |  | serialized |  | 
[SMSG_PARTY_MEMBER_STATS_FULL](#smsg_party_member_stats_full) |  |  | serialized |  | 
[CMSG_PET_SPELL_AUTOCAST](#cmsg_pet_spell_autocast) |  |  | serialized |  | 
[SMSG_WEATHER](#smsg_weather) |  |  | serialized |  | 
...
[CMSG_GUILD_INFO_TEXT](#cmsg_guild_info_text) |  |  | serialized | serialized | 
...
[CMSG_ACTIVATETAXIEXPRESS](#cmsg_activatetaxiexpress) |  |  | serialized |  | 
...
[CMSG_SET_FACTION_INACTIVE](#cmsg_set_faction_inactive) |  |  | serialized |  | 
...
[MSG_RAID_TARGET_UPDATE](#msg_raid_target_update) |  |  | serialized |  | 
[MSG_RAID_READY_CHECK](#msg_raid_ready_check) |  |  | serialized |  | 
[CMSG_LUA_USAGE](#cmsg_lua_usage) |  |  |  |  | 
[SMSG_PET_ACTION_SOUND](#smsg_pet_action_sound) |  |  | serialized |  | 
...
[SMSG_INSTANCE_DIFFICULTY](#smsg_instance_difficulty) |  |  | serialized |  | 
...
[SMSG_MOVE_UNSET_CAN_FLY](#smsg_move_unset_can_fly) |  |  | serialized |  | 
[CMSG_MOVE_SET_CAN_FLY_ACK](#cmsg_move_set_can_fly_ack) |  |  |  |  | 
[CMSG_MOVE_SET_FLY](#cmsg_move_set_fly) |  |  |  |  | 
[CMSG_SOCKET_GEMS](#cmsg_socket_gems) |  |  | serialized |  | 
...
[CMSG_ARENA_TEAM_QUERY](#cmsg_arena_team_query) |  |  | serialized |  | 
[SMSG_ARENA_TEAM_QUERY_RESPONSE](#smsg_arena_team_query_response) |  |  | serialized | serialized | 
[CMSG_ARENA_TEAM_ROSTER](#cmsg_arena_team_roster) |  |  | serialized |  | 
[SMSG_ARENA_TEAM_ROSTER](#smsg_arena_team_roster) |  |  |  |  | 
[CMSG_ARENA_TEAM_INVITE](#cmsg_arena_team_invite) |  |  | serialized |  | 
...
[CMSG_ARENA_TEAM_LEAVE](#cmsg_arena_team_leave) |  |  | serialized |  | 
[CMSG_ARENA_TEAM_REMOVE](#cmsg_arena_team_remove) |  |  | serialized |  | 
[CMSG_ARENA_TEAM_DISBAND](#cmsg_arena_team_disband) |  |  | serialized |  | 
[CMSG_ARENA_TEAM_LEADER](#cmsg_arena_team_leader) |  |  | serialized |  | 
[SMSG_ARENA_TEAM_EVENT](#smsg_arena_team_event) |  |  |  |  | 
[CMSG_BATTLEMASTER_JOIN_ARENA](#cmsg_battlemaster_join_arena) |  |  | serialized |  | 
[MSG_MOVE_START_ASCEND](#msg_move_start_ascend) |  |  |  |  | 
[MSG_MOVE_STOP_ASCEND](#msg_move_stop_ascend) |  |  |  |  | 
[SMSG_ARENA_TEAM_STATS](#smsg_arena_team_stats) |  |  | serialized |  | 
[CMSG_LFG_JOIN](#cmsg_lfg_join) |  |  |  |  | 
[CMSG_LFG_LEAVE](#cmsg_lfg_leave) |  |  |  |  | 
[CMSG_SEARCH_LFG_JOIN](#cmsg_search_lfg_join) |  |  | serialized |  | 
[CMSG_SEARCH_LFG_LEAVE](#cmsg_search_lfg_leave) |  |  | serialized |  | 
[SMSG_UPDATE_LFG_LIST](#smsg_update_lfg_list) |  |  |  |  | 
[SMSG_LFG_PROPOSAL_UPDATE](#smsg_lfg_proposal_update) |  |  |  |  | 
[CMSG_LFG_PROPOSAL_RESULT](#cmsg_lfg_proposal_result) |  |  | serialized |  | 
...
[CMSG_SET_LFG_COMMENT](#cmsg_set_lfg_comment) |  |  | serialized |  | 
[SMSG_LFG_UPDATE_PLAYER](#smsg_lfg_update_player) |  |  |  |  | 
[SMSG_LFG_UPDATE_PARTY](#smsg_lfg_update_party) |  |  |  |  | 
[SMSG_LFG_UPDATE_SEARCH](#smsg_lfg_update_search) |  |  | serialized |  | 
[CMSG_LFG_SET_ROLES](#cmsg_lfg_set_roles) |  |  | serialized |  | 
[CMSG_LFG_SET_NEEDS](#cmsg_lfg_set_needs) |  |  |  |  | 
[CMSG_LFG_SET_BOOT_VOTE](#cmsg_lfg_set_boot_vote) |  |  | serialized |  | 
...
[CMSG_LFG_TELEPORT](#cmsg_lfg_teleport) |  |  | serialized |  | 
[CMSG_LFD_PARTY_LOCK_INFO_REQUEST](#cmsg_lfd_party_lock_info_request) |  |  |  |  | 
[SMSG_LFG_PARTY_INFO](#smsg_lfg_party_info) |  |  |  |  | 
[SMSG_TITLE_EARNED](#smsg_title_earned) |  |  | serialized |  | 
[CMSG_SET_TITLE](#cmsg_set_title) |  |  | serialized |  | 
[CMSG_CANCEL_MOUNT_AURA](#cmsg_cancel_mount_aura) |  |  |  |  | 
[SMSG_ARENA_ERROR](#smsg_arena_error) |  |  | serialized | 
[MSG_INSPECT_ARENA_TEAMS](#msg_inspect_arena_teams) |  |  | serialized | 
[SMSG_DEATH_RELEASE_LOC](#smsg_death_release_loc) |  |  | serialized |  | 
[CMSG_CANCEL_TEMP_ENCHANTMENT](#cmsg_cancel_temp_enchantment) |  |  | serialized |  | 
...
[MSG_PARTY_ASSIGNMENT](#msg_party_assignment) |  |  | serialized |  | 
...
[SMSG_SET_EXTRA_AURA_INFO_OBSOLETE](#smsg_set_extra_aura_info_obsolete) |  |  | serialized |  | 
[SMSG_SET_EXTRA_AURA_INFO_NEED_UPDATE_OBSOLETE](#smsg_set_extra_aura_info_need_update_obsolete) |  |  |  |  | 
[SMSG_CLEAR_EXTRA_AURA_INFO_OBSOLETE](#smsg_clear_extra_aura_info_obsolete) |  |  | serialized |  | 
...
[SMSG_CROSSED_INEBRIATION_THRESHOLD](#smsg_crossed_inebriation_threshold) |  |  | serialized |  | 
...
[CMSG_CHANNEL_DISPLAY_LIST](#cmsg_channel_display_list) |  |  | serialized |  | 
...
[SMSG_CHANNEL_MEMBER_COUNT](#smsg_channel_member_count) |  |  | serialized |  | 
