...
------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------
[GossipCreateMenu(npc_text, pPlayer, 0))](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_GossipCreateMenu)                                                    | Creates a new NPC gossip menu with the TextID specified.
[GossipMenuAddItem(Icon, "Name", intid, code[, messagebox, gold])](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_GossipMenuAddItem)                          | Creates a new menu item, used after registering a new menu with GossipCreateMenu().
[GossipAddQuests(pPlayer)](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_GossipAddQuests)                                                                    | Adds quests to the gossip menu if any available.
[GossipSendMenu(pPlayer)](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_GossipSendMenu)                                                                      | Sends the gossip menu to the player.
[GossipComplete()](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_GossipComplete)                                                                             | Completes (closes) the player's gossip window.
[GossipSendPOI(X, Y, Icon, Flags, Data, Name)](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_GossipSendPOI)                                                  | Sets a mark on the player's mini map. Used when asking city guards where to go.
[GossipMiscAction(action, creature, intid)](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_GossipMiscAction)                                                  | Performs a Gossip Action. 


# Modify/Set Methods

------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------
[CallForHelpHp(hp)](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_CallForHelpHp)                                                                             | Sets the Unit's 'call for help' HP to the hp specified. Basically, when the Unit hits this HP he flees for help.
...
[DeMorph()](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_DeMorph)                                                                                           | Sets the Unit's display id back to it's native one.
...
[ModifyWalkSpeed(speed)](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_ModifyWalkSpeed)                                                                      | Modifies the Unit's walk speed to the specified speed.
...
[SetBindPoint(x, y, z, map, zone)](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_SetBindPoint)                                                               | Sets the Unit's bind point to the co-ordinates specified.
...
[SetDeathState(state)](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_SetDeathState)                                                                          | Sets the Unit's death state. 0 (Alive), 1 (Just Died), 2 (Corpse), 3 (Dead).
...
[SetFaction(faction)](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_SetFaction)                                                                              | Sets the Unit's faction to the faction specified.
...
[SetGender(1/2)](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_SetGender)                                                                                    | Sets the gender of a character.
[SetHealth(health)](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_SetHealth)                                                                                 | Sets the Unit's health an absolute value based on the number specified.
[SetHealthPct(percentage)](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_SetHealthPct)                                                                       | Sets the Unit's health to a percentage based on the percentage given.
...
[SetLevel(level)](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_SetLevel)                                                                                    | Sets the Player's level to the level given. Cannot exceed the max level in configs.
[SetMana(mana)](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_SetMana)                                                                                       | Sets the Unit's mana to the absolute value provided.
[SetMaxHealth(health)](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_SetMaxHealth)                                                                           | Sets the Unit's maximum amount of health to the number specified.
[SetMaxMana(mana)](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_SetMaxMana)                                                                                 | Sets the Unit's maximum mana to the absolute value provided.
SetMaxPower(amount[, type])                                                                                                                                              | Sets the Unit's maximum power to the absolute value and type provided.
[SetModel(id)](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_SetModel)                                                                                       | Sets the Unit's display id to the one specified. Returns true if successful, false if not.
...
[SetMoveRunFlag(1/0)](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_SetMoveRunFlag)                                                                          | Allows the Unit to run (if set to 1).
...
[SetPlayerSpeed(speed)](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_SetPlayerSpeed)                                                                        | Sets the player's global speed to speed.
SetPlayerWeather(type, density)                                                                                                                                          | Sets the player's weather to type, and makes the strength density.
[SetPosition(x, y, z, o)](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_SetPosition)                                                                         | Sets the Unit's position to the co-ordinates specified.
...
[SetScale(scale)](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_SetScale)                                                                                    | Sets the Unit's scale to the scale provided.
...
[SetUInt32Value(index, flag)](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_SetUInt32Value)                                                                  | Sets the Unit's uint32_t flag at index.
SetUInt64Value(field, guid)                                                                                                                                              | Sets the Unit's uint64_t guid at field.
[SetUnitToFollow(target, distance, angle)](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_SetUnitToFollow)                                                    | Follows the target specified, at the specified angle and will stop following when it reaches the amount of yards specified.
SetZoneWeather(zone, type, density)                                                                                                                                      | SetPlayerWeather() for zones.
[UnsetKnownTitle(id)](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_UnsetKnownTitle)                                                                         | Removes the title specified. This is not saved to the database.
...
[AddAura(id, duration[, temp])](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_AddAura)                                                                       | Buffs/Debuffs the current unit/player with the spell specified, with the duration specified. Setting temp to true allows it to stay on after logging. 
[AddItem(item, quantity)](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_AddItem)                                                                             | Gives the player an amount of items. Returns the item added or nil.
...
[CastSpell(spell)](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_CastSpell)                                                                                  | Casts the specified spell. Any cast time is ignored.
CastSpellAoF(x, y, z, id)                                                                                                                                                | Casts the targeted AoE spell (Think Blizzard & Shadowfury) at the given area. Ignores cast times.
[CastSpellOnTarget(spell, target)](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_CastSpellOnTarget)                                                          | Casts the specified spell on the target. Any cast time is ignored.
...
[CreateCustomWaypointMap()](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_CreateCustomWaypointMap)                                                           | Creates a custom Waypoint map for unit, and destroys the previous one if it existed.
...
[CreateWaypoint(x, y, z, o, wait, flags, model)](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_CreateWaypoint)                                               | Creates a Waypoint and appends it to the Waypoint Map.
[DealDamage(target, damage, spell)](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_DealDamage)                                                                | Deals damage to the target with the specified spell.
...
[Emote(id, time)](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_Emote)                                                                                       | Makes the Unit use the emote specified. If time is greater than 0, then it is preformed after a delay of (time)ms.
...
[FullCastSpell(spell)](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_FullCastSpell)                                                                          | Casts the specified spell. If the spell has a cast time, it is used.
[FullCastSpellOnTarget(spell, target)](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_FullCastSpellOnTarget)                                                  | Casts the specified spell on the target. If the spell has a cast time, it is used.
...
[HandleEvent(unit, eventid, misc1)](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_HandleEvent)                                                               | Unknown, see core for usage.
...
[KickPlayer(delay)](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_KickPlayer)                                                                                | Kicks the player after the delay. Please leave your message after the beep. 
Kill(target)                                                                                                                                                             | Causes the Unit to kill the target.
Land(1/0)                                                                                                                                                                | Disables flying if set to 1.
[LearnSpell(spell)](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_LearnSpell)                                                                                | Teaches the Unit the spell given.
...
[PlayerSendChatMessage(type, language, message)](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_PlayerSendChatMessage)                                        | Forces the Player to send the message with the parameters specified.
PlaySoundToPlayer(sound)                                                                                                                                                 | Like [PlaySoundToSet(sound)](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_PlaySoundToSet), only the sound only plays to the player specified.
[PlaySoundToSet(sound)](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_PlaySoundToSet)                                                                        | Plays the specified sound ID to everyone in the Unit's map cell.
...
[RegisterEvent(name, delay, repeats)](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_RegisterEvent)                                                           | Registers the method given with the delay given and repeats (0 repeats indefinitely). The name can either be a reference, a direct method or a string value of the method.
RemoveAIUpdateEvent()                                                                                                                                                    | Removes all AI Update Events.
[RemoveAllAuras()](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_RemoveAllAuras)                                                                             | Removes all auras on the Unit.
RemoveArenaPoints(amount)                                                                                                                                                | Removes the amount of arena points from the Unit specified.
[RemoveAura(id)](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_RemoveAura)                                                                                   | Removes the aura specified from the Unit.
...
[RemoveEvents()](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_RemoveEvents)                                                                                 | Removes all events registered with RegisterEvent().
RemoveFromWorld()                                                                                                                                                        | Removes the Unit from the world.
[RemoveItem(item, quantity)](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_RemoveItem)                                                                       | Removes an item from the player with the count specified.
...
[ResetAllTalents()](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_ResetAllTalents)                                                                           | Resets the player's talents.
...
[SavePlayer()](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_Root)                                                                                           | Saves the player to the database.
SendAreaTriggerMessage(string)                                                                                                                                           | Sends an Area Trigger message with the specified string to the player.
[SendBroadcastMessage(string)](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_SendBroadcastMessage)                                                           | Broadcasts the specified string to the player.
[SendChatMessage(type, language, message)](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_SendChatMessage)                                                    | Sends a chat message with the parameters specified.
...
[SendChatMessageToPlayer(type, language, message, player)](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_SendChatMessageToPlayer)                            | Sends the player specified a chat message with the parameters designated.
...
[SpawnCreature(entry, x, y, z, o, faction, duration[, equip1, equip2, equip3, phase, save])](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_SpawnCreature)    | Spawns a creature in the Unit's map with the co-ordinates and faction specified. Despawns after duration (0 for no despawn).
[SpawnGameObject(id, x, y, z, o, duration, scale[, phase, save])](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_SpawnGameObject)                             | Spawns a GameObject in the Unit's map with the co-ordinates and scale specified. Despawns after duration (0 for no despawn).
SpellNonMeleeDamageLog(victim, spell, damage, allowproc, staticdmg, noremoveauras)                                                                                       | Unknown, Check core for usage.
[StartTaxi(taxipath, display)](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_StartTaxi)                                                                      | Forces the Unit to start the taxi path specified, and mount it on the specified display id.
...
[Unroot()](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_Unroot)                                                                                             | Allows movement.
