...
[GetUInt32Value(field)](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_GetUInt32Value)                                                                        | Returns the UInt32Value for Unit at field. (Disabled)
...
ModFloatValue(float)                                                                                                                                                     | Modifies the Unit's float value to the float specified. (Disabled)
...
[SetUInt32Value(index, flag)](/Wiki/docs/standards_sctipts/methods_lua/Unit_Methods/Lua_SetUInt32Value)                                                                  | Sets the Unit's uint32_t flag at index. (Disabled)
